...
if(isset($_SESSION['email_not'])){
    $email_error = $_SESSION['email_not'];
    unset($_SESSION['email_not']);
} else {
    $email_error = "";
}

if(isset($_SESSION['username_not'])){
    $username_error = $_SESSION['username_not'];
    unset($_SESSION['username_not']);
} else {
    $username_error = "";
}
...
<form action="Backend/reg.php" method="post" onsubmit="return errorChecker()">
    ...
    <input type="email" name="email" placeholder="Email or Phone" id="email">
